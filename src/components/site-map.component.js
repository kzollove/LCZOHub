...
export default class SiteMap extends Component {
    ...
    siteCoords() {
        ...
        return this.state.sites.map(currentsite => {
            return <Marker position={[currentsite.location.lat, currentsite.location.lon]} icon={myIcon}>
                <Popup>Site: <Link to={"/site/" + currentsite.code}>{currentsite.name}</Link></Popup>
            </Marker>
        })
    }
    render() {
